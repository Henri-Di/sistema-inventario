...
<div class="container-fluid">
    ...
    <div class="row content" id="row-content">
        ...
        <div class="col-sm-3 sidenav hidden-xs" id="blue-sidenav-hidden-xs">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li id="list-blue"><a id="menu-blue" href="../ViewForms/PainelAnalista.php"><i class="fa fa-user " id="blue-icon-btn-painel" style="margin-left:1%; font-size:15px;">Painel Administrativo</i></a></li><br>
                <li id="list-blue"><a id="menu-blue" href="../ViewRelatorio/RelatorioCadastroAuxiliar.php"><i class="fa fa-puzzle-piece " id="blue-icon-btn-painel" style="margin-left:1%; font-size:15px;"></i>Relatório Cadastro Auxiliar</a></li><br>
                <li id="list-blue"><a id="menu-blue" href="../ViewRelatorio/RelatorioProduto.php"><i class="fa fa-cube " id="blue-icon-btn-painel" style="margin-left:1%; font-size:15px;"></i>Relatório Produto</a></li><br>
                <li id="list-blue"><a id="menu-blue" href="../ViewRelatorio/RelatorioNotaFiscal.php"><i class="fa fa-cart-plus " id="blue-icon-btn-painel" style="margin-left:1%; font-size:15px;"></i>Relatório Nota Fiscal</a></li><br>
            </ul>
            </nav>
            <!-- End menu-link page -->
    ...
    <div class="alert">
        ...
        <!-- Mensagem de erro -->
        O datacenter de origem da transferência não foi identificado. Tente novamente  <i class='fa fa-times-circle'></i>
    </div>
    <style>
                    .alerts {
                        padding: 5px;
