...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel"> Acrescentar Produto <i class="fa fa-level-up" id="blue-icon-btn-painel"></i></p>
</div>
<br>
...
} // Fim do bloco else (quando há resultados da consulta)
?>
<br>
<?php
// Conexão e consulta ao banco de dados
...
if ($resultado->num_rows === 0) {
    ...
    <!-- Início do formulário para adicionar quantidade -->
    <form method="POST" action="../ViewFunctions/CreateAcrescimo.php">
        <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
            <?php while($dado = $resultado->fetch_assoc()) { ?>
                <tr id="line-blue-table">
                    <td id="colun-blue-table">
                        <!-- Input hidden para enviar o ID do produto -->
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input id="blue-input-cdst" type="number" value="" name="Acrescimo" autocomplete="off" required/>
                    </td>
                    <td id="colun-blue-table">
                        <p id="blue-title-listar">Data Registro</p>
                        <input id="blue-input-cdst" type="date" value="" name="DataAcrescimo" autocomplete="off" required/>
                    </td>
                    <td id="colun-blue-table">
        ...
        <button type="submit" id="blue-btn-table-cadastro-produto">Acrescentar Produto <i class="fa fa-level-up" id="blue-icon-btn-painel"></i></button>
    </form>
<?php } ?>
