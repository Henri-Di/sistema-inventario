...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel"> Transferir Produto <i class="fa fa-retweet" id="blue-icon-btn-painel"></i></p>
</div>
...
<table class="table table-bordered" id="blue-table-cadastro-auxiliar">
    <tr id="line-blue-table">
        <form method="POST" action="CreateReserva.php">
            ...
            <td id="colun-blue-table">
                <div id="blue-title-listar">Estoque
...
<?php } ?>  
<!-- End código PHP para repetição de dados do produto -->
<?php } ?>]
<br>
 <!-- Start formulario sobrepor material -->
<form method="POST" action="../ViewFunctions/CreateTransferencia.php">
...
<table class="table table-bordered" id="blue-table-cadastro-auxiliar">
    ...
    <tr id="line-blue-table">
        ...
        <td id="colun-blue-table">
            <p id="blue-title-listar">Estoque Transfererir </p>
        ...
        <td id="colun-blue-table">
            <p id="blue-title-listar">DataCenter</p>
...
<button type="submit" id="blue-btn-table-cadastro-produto">Transferir Produto <i class="fa fa-retweet" id="blue-icon-btn-painel"></i></button>
