...
<div id="blue-line-title-btn-painel">
    ...
    <p id="blue-title-btn-painel">Remover Produto <i class="fa fa-trash" id="blue-icon-btn-painel"></i></p>
</div>

<br>

<!-- Mensagem de confirmação de remoção do produto -->
<p id="blue-title-btn-painel" style="margin-bottom:1%;">Deseja realizar a remoção do produto:</p>
...
if ($resultado->num_rows === 0) {
    ...
    <!-- Início do loop PHP para listagem dos produtos -->
    <?php while($dado = $resultado->fetch_assoc()) { ?>
        ...
        <!-- Botão para remoção do produto -->
        <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='../ViewFunctions/CreateDeleteProduto.php?id=<?php echo $dado['IDPRODUTO'];?>';">Remover Produto  <i class="fa fa-trash"></i></button>

    <?php } ?>
    <!-- Fim do loop PHP para listagem dos produtos -->
