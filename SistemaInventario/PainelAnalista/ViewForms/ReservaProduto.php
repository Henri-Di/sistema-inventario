...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel"> Reservar Produto <i class="fa fa-star" id="blue-icon-btn-painel"></i></p>
</div>
<br>
...
if ($resultado->num_rows === 0) {
    ...
    <?php while($dado = $resultado->fetch_assoc()) { ?>
        ...
        <!-- Start formulario reserva produto -->
            ...
            <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
                <tr id="line-blue-table">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="DataCadastro" value="<?php echo date("d/m/Y", strtotime($dado['DATACADASTRO']));?>" autocomplete="off" required disabled /><br>
                    </td>
        ...
        <!-- End formulario reserva produto -->
    <?php } ?>
    <!-- End código PHP para repetição de listagem -->
<?php } ?>
<br>
<!-- Start formulario sobrepor material -->
<form method="POST" action="../ViewFunctions/CreateReserva.php">
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliar">     
        ...
        <tr id="line-blue-table">
            ...
            if ($resultado->num_rows === 0) {
                ...
                // Loop para mostrar os dados do produto
            ...
            <td id="colun-blue-table"> 
                <p id="blue-title-listar">Nº WO</p> 
                <input id="blue-input-cdst" type="text" value="" name="NumWo" autocomplete="off" required/>
            </td>

            <td id="colun-blue-table"> 
                <p id="blue-title-listar">Estoque Atual</p> 
                <input id="blue-input-cdst" type="number" value="<?php echo $dado['QUANTIDADE']; ?>" name="Quantidade" disabled/>
            </td>

            <td id="colun-blue-table"> 
                <p id="blue-title-listar">Estoque Reservado</p> 
                <input id="blue-input-cdst" type="number" value="" name="Reservar" autocomplete="off" required/>
            </td>

            <td id="colun-blue-table"> 
                <p id="blue-title-listar">Data Reserva</p> 
                <input id="blue-input-cdst" type="date" value="" name="DataReserva" autocomplete="off" required/>
            </td>

            <td id="colun-blue-table"> 
                <p id="blue-title-listar">Observações</p> 
    ...
    <!-- Botão de submit para reservar produto -->
