...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Log Devolução</title>
...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Log Devolução <i class="fa fa-exchange" id="blue-icon-btn-painel"></i></p>
</div>
...
// Consulta SQL para obter informações de devolução relacionadas ao produto
$consulta = "SELECT * FROM DEVOLVER WHERE IDPRODUTO='$id'";
...
<div class="container-fluid" style="width: 100%; height: 300px; overflow-y: auto; overflow-x: hidden; margin-top: 1%;">
    ...
    <!-- Loop para exibir os dados de devolução -->
    <?php while ($dado = $con->fetch_array()) { ?>
        <!-- Conversão de data para formato brasileiro -->
        <?php
        $date = strtotime($dado['DATADEVOLUCAO']);
        $dateformated = date("d/m/Y", $date);
        ?>
            ...
            <tr id="line-blue-table-hover">
                <form method="POST" action="">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="QuantidadeDevolucao" value="<?php echo $dado['QUANTIDADE']; ?>" autocomplete="off" required disabled /><br>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="DataDevolucao" value="<?php echo $dateformated; ?>" autocomplete="off" required disabled /><br>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="ObservacaoDevolucao" value="<?php echo $dado['OBSERVACAO']; ?>" autocomplete="off" required disabled /><br>
                    </td>
