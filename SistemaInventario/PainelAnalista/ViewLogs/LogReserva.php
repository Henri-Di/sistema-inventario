...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Log Reserva </title>
...
<div class="container-fluid" style="width: 100%; height: 300px; overflow-y: auto; overflow-x: hidden; margin-top: 1%;">
    ...
    $consulta = "SELECT * FROM RESERVA WHERE IDPRODUTO='$id'";
    $con = mysqli_query($conn, $consulta) or die(mysqli_error($conn));
    ?>
    <!-- Fim do código PHP para consultar dados de reserva -->

    <!-- Início do loop PHP para exibir dados de reserva -->
    <?php while ($dado = $con->fetch_array()) { ?>

        <!-- Início do código PHP para conversão de data para formato brasileiro -->
        <?php
        $dateReserva = strtotime($dado['DATARESERVA']);
        $dateformatedReserva = date("d/m/Y", $dateReserva);

        // Determina a cor do texto com base na situação da reserva
        $color = '';
        ...
        <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
            <tr id="line-blue-table-hover">
                <form method="POST" action="../ViewFunctions/CreateAcaoReserva.php">
                    ...
                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Código Reserva</div>
                    ...
                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Ação Reserva</div>
                    ...
                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Confirmar Ação</div>
