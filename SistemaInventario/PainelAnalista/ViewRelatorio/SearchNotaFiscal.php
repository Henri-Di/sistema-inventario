...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Resultado Pesquisa Nota Fiscal</title>
...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">
        Resultado Relatório Nota Fiscal 
        <i class="fa fa-cart-plus" id="blue-icon-btn-painel"></i>
    </p>
</div>
...
<div class="container" style="width:100%;height:541px;overflow-y:auto;">
    ...
    <!--  Start If de verificação do serach encaminhado -->
    <?php if ($result_search) { ?>

        <!--  Start repetição do serach encaminhado -->   
        <?php while ($rows_search = mysqli_fetch_array($resultado_search)) { ?>
            ...
            // $data agora é um inteiro timestamp
            ...
            <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
                <tr id="line-blue-table-hover">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <a id="blue-optios-config-dados" href='../ViewFunctions/CreateDownloadNotaFiscal.php?file=<?php echo urlencode($rows_search['FILEPATH']); ?>'>
