...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Resultado Pesquisa Usuario</title>
...
<div class="container-fluid" style="width:100%;height:541;overflow-y:auto">
    <br>
    ...
    // Proteção contra SQL Injection escapando caracteres especiais
    $search = mysqli_real_escape_string($conn, $search);

    // Consulta SQL para buscar em múltiplos campos da tabela USUARIO
    $result_search = "
    SELECT * 
    FROM USUARIO 
            ...
            <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
                <tr id="line-blue-table-hover">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarUsuario.php?id=<?php echo $rows_search['IDUSUARIO'];?>';">
                            <i class="fa fa-pencil" id="blue-icon-relatorio-produto"></i>
                        </div>
                    </td>
                    <td id="colun-blue-table">
                        <p id="blue-title-listar-exibicao">Remover</p>
                        <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteUsuario.php?id=<?php echo $rows_search['IDUSUARIO'];?>';">
    ...
    <?php } ?>
    <!-- End If de verificação do search encaminhado -->
</div>    
<br><br>
<!-- Rodapé da página -->
