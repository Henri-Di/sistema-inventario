...
<div class="container-fluid">
    ...
    <div id="blue-line-title-btn-painel">
        <p id="blue-title-btn-painel">Modificar Usuário <i class="fa fa-pencil" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
    </div>
...
// Obter o ID do usuário da URL e filtrar como número inteiro
...
if ($resultado->num_rows === 0) {
    ...
    <!-- Formulário para modificar usuário -->
    <form method="POST" action="../ViewFunctions/CreateModificaUsuario.php">
        <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
            <tr id="line-blue-table">
                ...
                <td id="colun-blue-table">
                    ...
                    <input type="text" id="blue-input-cdst" value="<?php echo $usuario['IDUSUARIO']; ?>" name="codigo" disabled>
                </td>

                <!-- Campo Nome -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">Nome</div>
                    <input type="text" id="blue-input-cdst" value="<?php echo $usuario['NOME']; ?>" name="Nome" required>
                </td>

                <!-- Campo CódigoP -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">CódigoP</div>
                    <input type="text" id="blue-input-cdst" value="<?php echo $usuario['CODIGOP']; ?>" name="CodigoP" required>
                </td>

                <!-- Campo Email -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">Email</div>
                    <input type="email" id="blue-input-cdst" value="<?php echo $usuario['EMAIL']; ?>" name="Email" required>
                </td>
                ...
                <td id="colun-blue-table">
                    ...
                    <select id="select-form" name="DataCenter">
                        <option id="select-option-form" value="<?php echo $usuario['DATACENTER']; ?>"><?php echo $usuario['DATACENTER']; ?></option>
                ...
                <td id="colun-blue-table">
                    ...
                    <select id="select-form" name="NivelAcesso">
                        <option id="select-option-form" value="<?php echo $usuario['NIVEL_ACESSO']; ?>"><?php echo $usuario['NIVEL_ACESSO']; ?></option>
                        <option id="select-option-form" value="GESTOR">GESTOR</option>
                        <option id="select-option-form" value="PREPOSTO">PREPOSTO</option>
                        <option id="select-option-form" value="ANALISTA">ANALISTA</option>
                        <option id="select-option-form" value="TÉCNICO">TÉCNICO</option>
                    </select>
                </td>
            </tr>
        </table>
        ...
        <div class="btn-form">
            <button type="submit" id="blue-btn-table-cadastro-produto">Modificar Usuário  <i class="fa fa-pencil"></i></button>
        </div>
    </form>

    <?php } // Fechar o bloco else ?>
