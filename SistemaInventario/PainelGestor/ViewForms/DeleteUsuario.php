...
<div class="container-fluid">
    ...
    <div id="blue-line-title-btn-painel">
        <p id="blue-title-btn-painel">Remover Usuário <i class="fa fa-trash" id="blue-icon-btn-painel" style="font-size:12px;"></i></p>
    </div>
        ...
        <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
            <tr id="line-blue-table">
                ...
                <td id="colun-blue-table">
                    ...
                    <input type="text" id="blue-input-cdst" value="<?php echo $usuario['NOME']; ?>" name="Nome" disabled>
                </td>

                <!-- Campo CódigoP -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">CódigoP</div>
                    <input type="text" id="blue-input-cdst" value="<?php echo $usuario['CODIGOP']; ?>" name="CodigoP" disabled>
                </td>

                <!-- Campo Email -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">Email</div>
                    <input type="email" id="blue-input-cdst" value="<?php echo $usuario['EMAIL']; ?>" name="Email" disabled>
                </td>

                <!-- Campo Data Center -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">Data Center</div>
                    <input type="email" id="blue-input-cdst" value="<?php echo $usuario['DATACENTER']; ?>" name="DataCenter" disabled>
                </td>

                <!-- Campo Nível de Acesso -->
                <td id="colun-blue-table">
                    <div id="blue-title-listar">Nível de Acesso</div>
                    <input type="email" id="blue-input-cdst" value="<?php echo $usuario['NIVEL_ACESSO']; ?>" name="NivelAcesso" disabled>
                </td>
            </tr>
        </table>
        <!-- Botão para salvar as alterações -->
        <div class="btn-form">
        <button type="submit" id="blue-btn-table-cadastro-produto" onclick="window.location.href='../ViewFunctions/CreateDeleteUsuario.php?id=<?php echo $dado['IDUSUARIO'];?>';">Remover Usuário <i class="fa fa-trash"></i></button>
        </div>
    </form>
