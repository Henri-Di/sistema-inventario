...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Log Transferência Saída</title>
...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Confirmação Transferência <i class="fa fa-retweet" id="blue-icon-btn-painel"></i></p>
</div>
...
<div class="container-fluid" style="margin-left: 20%;">
    ...
    <table class="table table-bordered" style="width: 60%; height: auto;">
        ...
        <tr id="line-blue-table">
            <form method="POST" action="../ViewFunctions/CreateProcessaTransferencia.php">
                ...
                <td id="colun-blue-table">
                    ...
                    <input type="text" id="blue-input-cdst" name="idTransferencia" value="" autocomplete="off" required /><br>
                </td>
                ...
                <td id="colun-blue-table">
                    ...
                    <!-- End container title input form -->
                    <select id="select-form" name="Acao">
        ...
        <button type="submit" id="blue-button-nova-senha">Confirmar Transferência <i class="fa fa-retweet" id="blue-icon-btn-painel"></i></button>
...
<div class="container-fluid" style="width: 100%; height: 270px; overflow-y: auto; overflow-x: hidden; margin-top: 1%;">
    ...
    $id = $_GET['id'] ?? '';
    // Sanitiza o ID do produto para evitar injeção de SQL
    ...
    $sql = "SELECT 
            ...
            JOIN 
                DATACENTER DC_ORIGEM ON P_ORIGEM.IDDATACENTER = DC_ORIGEM.IDDATACENTER
            WHERE 
                T.IDPRODUTO_ORIGEM = ? OR T.IDPRODUTO_DESTINO = ?";
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Determina a cor do texto com base na situação
                $color = '';
                switch ($row['SITUACAO']) {
                    case 'PENDENTE':
                        $color = '#ff6600';
                    ...
                    <tr>
                        <form method="POST" action="">
                            ...
                            <td id="colun-blue-table">
                                ...
                                <!-- Fim do contêiner do título do formulário de entrada -->
                                <input type="text" id="blue-input-cdst" name="CodigoSaida" value="<?php echo $row['ID']; ?> " autocomplete="off" required disabled /><br>
                            </td>
                            ...
                            <td id="colun-blue-table">
                                ...
                                <!-- Fim do contêiner do título do formulário de entrada -->
                                <input type="text" id="blue-input-cdst" name="ProdutoOorigem" value="<?php echo $row['NOME_MATERIAL_ORIGEM']; ?> " autocomplete="off" required disabled /><br>
                            </td>
                            ...
                            <td id="colun-blue-table">
                                ...
                                <!-- Fim do contêiner do título do formulário de entrada -->
                                <input type="text" id="blue-input-cdst" name="DataTransferencia" value="<?php echo $dateformated; ?> " autocomplete="off" required disabled /><br>
                            </td>
                            ...
                            <td id="colun-blue-table">
                                ...
                                <!-- Fim do contêiner do título do formulário de entrada -->
                                <input type="text" id="blue-input-cdst" name="ObservacaoTransferencia" value="<?php echo $row['OBSERVACAO']; ?> " autocomplete="off" required disabled /><br>
                            </td>
                            ...
                            <td id="colun-blue-table">
                                ...
                                <!-- Fim do contêiner do título do formulário de entrada -->
                                <input type="text" id="blue-input-cdst" name="SituacaoTransferencia" value="<?php echo $row['SITUACAO']; ?> " style="color: <?php echo $color; ?>;" autocomplete="off" required disabled /><br>
                            </td>
