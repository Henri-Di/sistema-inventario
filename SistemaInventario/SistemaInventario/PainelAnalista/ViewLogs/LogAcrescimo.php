...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Log Acréscimo</title>
...
<div class="container-fluid" style="width: 100%; height: 300px; overflow-y: auto; overflow-x: hidden; margin-top: 1%;">
    ...
    <?php while ($dado = $con->fetch_array()) { ?>
        ...
        <?php
        $date = strtotime($dado['DATAACRESCIMO']);
        $dateformated = date("d/m/Y", $date);
        ?>
            ...
            <tr id="line-blue-table-hover">
                <form method="POST" action="">
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="QCodigoAcrescimo" value="<?php echo $dado['ID']; ?>" autocomplete="off" required disabled /><br>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="QuantidadeAcrescimo" value="<?php echo $dado['QUANTIDADE']; ?>" autocomplete="off" required disabled /><br>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="DataAcrescimo" value="<?php echo $dateformated; ?>" autocomplete="off" required disabled /><br>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="ObservacaoAcrescimo" value="<?php echo $dado['OBSERVACAO']; ?>" autocomplete="off" required disabled /><br>
                    </td>
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="Nome" value="<?php echo $dado['NOME']; ?>" autocomplete="off" required disabled /><br>
                    </td>
