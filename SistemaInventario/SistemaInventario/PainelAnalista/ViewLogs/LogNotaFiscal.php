...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Log Nota Fiscal </title>
...
// Consulta SQL para obter informações da nota fiscal relacionadas ao produto
$consulta = "SELECT * FROM NOTAFISCAL WHERE IDPRODUTO='$id'";
...
<div class="container-fluid" style="width: 100%; height: 300px; overflow-y: auto; overflow-x: hidden; margin-top: 1%;">
    ...
    <?php while ($dado = $con->fetch_array()) { ?>
        <!-- Conversão de datas para formato brasileiro -->
        <?php
        $dateRecebimento = strtotime($dado['DATARECEBIMENTO']);
        $dateformatedRecebimento = date("d/m/Y", $dateRecebimento);

        $dateCadastro = strtotime($dado['DATACADASTRO']);
        $dateformatedCadastro = date("d/m/Y", $dateCadastro);
        ?>
            ...
            <form method="POST" action="">
                <tr id="line-blue-table">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="ValorNotaFiscal" value="R$<?php echo $dado['VALORNOTAFISCAL']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Material</div>
                        <input type="text" id="blue-input-cdst" name="Material" value="<?php echo $dado['MATERIAL']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Conector</div>
                        <input type="text" id="blue-input-cdst" name="Conector" value="<?php echo $dado['CONECTOR']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Metragem</div>
                        <input type="text" id="blue-input-cdst" name="Metragem" value="<?php echo $dado['METRAGEM']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Modelo</div>
                        <input type="text" id="blue-input-cdst" name="Modelo" value="<?php echo $dado['MODELO']; ?>" autocomplete="off" required disabled />
                    </td>
                </tr>
                ...
                <tr id="line-blue-table">
                    <td id="colun-blue-table">
                        ...
                        <input type="number" id="blue-input-cdst" name="Quantidade" value="<?php echo $dado['QUANTIDADE']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Fornecedor</div>
                        <input type="text" id="blue-input-cdst" name="Fornecedor" value="<?php echo $dado['FORNECEDOR']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Data Recebimento</div>
                        <input type="date" id="blue-input-cdst" name="DataRecebimento" value="<?php echo $dado['DATARECEBIMENTO']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Data Cadastro</div>
                        <input type="date" id="blue-input-cdst" name="DataCadastro" value="<?php echo $dado['DATACADASTRO']; ?>" autocomplete="off" required disabled />
                    </td>

                    <td id="colun-blue-table">
                        <div id="blue-title-listar">Data Center</div>
                        <input type="text" id="blue-input-cdst" name="DataCenter" value="<?php echo $dado['DATACENTER']; ?>" autocomplete="off" required disabled />
                    </td>
