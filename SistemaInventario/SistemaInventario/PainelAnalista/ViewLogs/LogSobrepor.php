...
<div class="container-fluid" style="width: 100%; height: 300px; overflow-y: auto; overflow-x: hidden; margin-top: 1%;">
    ...
    <!-- Início do código PHP para consultar dados de sobreposição -->
    <?php
    require_once('../../ViewConnection/ConnectionInventario.php');
    ...
    $con = mysqli_query($conn, $consulta) or die(mysqli_error($conn));
    ?>
    <!-- Fim do código PHP para consultar dados de sobreposição -->

    <!-- Início do loop PHP para exibir dados de sobreposição -->
    <?php while ($dado = $con->fetch_array()) { ?>

        <!-- Início do código PHP para conversão de data para formato brasileiro -->
        <?php
        $dateSobrepor = strtotime($dado['DATASOBREPOR']);
        $dateformatedSobrepor = date("d/m/Y", $dateSobrepor);
        ?>
            ...
            <tr id="line-blue-table-hover">
                <form method="POST" action="">
                    ...
                    <td id="colun-blue-table">
                        ...
                        <input type="text" id="blue-input-cdst" name="DataSobrepor" value="<?php echo $dateformatedSobrepor; ?> " autocomplete="off" required disabled /><br>
                    </td>
