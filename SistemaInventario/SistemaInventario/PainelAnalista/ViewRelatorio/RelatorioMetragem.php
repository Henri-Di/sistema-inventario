...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Relatório Metragem</title>
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliars">
        <tr id="line-blue-table-hover">
            <td id="colun-blue-table">
                ...
                <p id="blue-text-table-exibicao"><?php echo $dado['IDMETRAGEM']; ?></p>
            </td>
            <td id="colun-blue-table">
            ...
            <td id="colun-blue-table">
                ...
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/ModificarMetragem.php?id=<?php echo $dado['IDMETRAGEM'];?>';">
                    <i class="fa fa-pencil" id="blue-icon-relatorio-produto"></i>
                </div>
            </td>
            <td id="colun-blue-table">
                <p id="blue-title-listar-exibicao">Remover</p> 
                <div id="blue-optios-config-dados" onclick="window.location.href='../ViewForms/DeleteMetragem.php?id=<?php echo $dado['IDMETRAGEM'];?>';">
