...
<div class="container-fluid" style="width:100%;height:530px;overflow-y:auto">
    <br>
    ...
    <?php
            ...
            echo '<p style="color:red; text-align:center;margin-top:25%;font-size:15px;">Nenhum produto encontrado</p>';
        }
        $stmt->close();
    }
    ?>
