...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Modificar Metragem</title>
...
<div class="container-fluid">
    ...
    <p id="blue-title-btn-painel">Modificar Metragem <i class="fa fa-pencil" id="blue-icon-btn-painel"></i></p>
</div>
...
<div class="container-fluid" style="margin-left:25%;">
    <table class="table table-bordered" style="width:60%;height:auto;">
        <form method="POST" class="example" action="../ViewFunctions/CreateModificaMetragem.php">
            
            <!-- Início do código PHP para listagem dos metragens -->
            <?php 
                require_once('../../ViewConnection/ConnectionInventario.php'); 
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['METRAGEM']; ?>" name="Metragem"/>
                    </td>
                </tr>
            <?php } ?>
            <!-- Fim do código PHP para repetição de listagem -->
    ...
    <button type="submit" id="blue-button-nova-senha">Modificar Metragem <i class="fa fa-pencil"></i></button>
    </form>
</div>
