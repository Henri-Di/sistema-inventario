...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel"> Sobrepor Produto <i class="fa fa-refresh" id="blue-icon-btn-painel"></i></p>
</div>
...
if ($resultado->num_rows === 0) {
    ...
    <?php while ($dado = $resultado->fetch_assoc()) { ?>
        ...
        <form method="POST" action="../ViewFunctions/CreateSobrepor.php">
            ...
            <table class="table table-bordered" id="blue-table-cadastro-auxiliar">     
                <tr id="line-blue-table">
                    ...
                    <td id="colun-blue-table"> 
                        ...
                        <input id="blue-input-cdst" type="number" value="" name="Sobrepor" autocomplete="off" required/>
                    </td>
                    
                    <td id="colun-blue-table"> 
                        <p id="blue-title-listar">Data Registro</p> 
                        <input id="blue-input-cdst" type="date" value="" name="DataSobrepor" autocomplete="off" required/>
                    </td>
        ...
        <!-- End formulario sobrepor material -->
