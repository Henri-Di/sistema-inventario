...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel"> Diminuir Produto <i class="fa fa-level-down" id="blue-icon-btn-painel"></i></p>
</div>
...
if ($resultado->num_rows === 0) {
    ...
    // Loop para exibir os dados do produto
...
<form method="POST" action="../ViewFunctions/CreateSubtracao.php">
    ...
    <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
        <tr id="line-blue-table">
            ...
            <td id="colun-blue-table">
                ...
                <input id="blue-input-cdst" type="number" value="" name="Subtracao" autocomplete="off" required/>
            </td>

            <td id="colun-blue-table">
                <p id="blue-title-listar">Data Registro</p>
                <input id="blue-input-cdst" type="date" value="" name="DataSubtracao" autocomplete="off" required/>
            </td>

            <td id="colun-blue-table">
                <p id="blue-title-listar">Observação</p>
                <input id="blue-input-cdst" type="text" value="" name="Observacao" autocomplete="off" required/>
            </td>
        </tr>
    </table>

    <button type="submit" id="blue-btn-table-cadastro-produto">Diminuir Produto <i class="fa fa-level-down" id="blue-icon-btn-painel"></i></button>
