...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Modificar Fornecedor</title>
...
<div class="container-fluid">
    ...
    <p id="blue-title-btn-painel">Modificar Fornecedor <i class="fa fa-pencil" id="blue-icon-btn-painel"></i></p>
</div>
...
<div class="container-fluid" style="margin-left:25%;">
    <table class="table table-bordered" style="width:60%;height:auto;">
        <form method="POST" class="example" action="../ViewFunctions/CreateModificaFornecedor.php">
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['FORNECEDOR']; ?>" name="Fornecedor"/>
                    </td>
                </tr>
            <?php } ?>
            <!-- Fim do código PHP para repetição de listagem -->
    ...
    <button type="submit" id="blue-button-nova-senha">Modificar Fornecedor <i class="fa fa-pencil"></i></button>
    </form>
</div>
