...
<head>
    ...
    <!-- Title page -->
    <title>Sistema de Inventário - Modificar Conector</title>
...
<div class="container-fluid">
    ...
    <p id="blue-title-btn-painel">Modificar Conector <i class="fa fa-pencil" id="blue-icon-btn-painel"></i></p>
</div>
...
<div class="container-fluid" style="margin-left:25%;">
    <table class="table table-bordered" style="width:60%;height:auto;">
        <form method="POST" class="example" action="../ViewFunctions/CreateModificaConector.php">
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                    <td id="colun-blue-table">   
                        ...
                        <input type="text" id="blue-input-cdst" value="<?php echo $dado['CONECTOR']; ?>" name="Conector"/>
                    </td>
                </tr>
            <?php } ?>
            <!-- Fim do código PHP para repetição de listagem -->
    ...
    <button type="submit" id="blue-button-nova-senha">Modificar Conector <i class="fa fa-pencil"></i></button>
    </form>
</div>
