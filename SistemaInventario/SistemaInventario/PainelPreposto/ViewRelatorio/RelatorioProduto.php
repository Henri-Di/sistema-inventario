...
<div id="blue-line-title-btn-painel">
    <p id="blue-title-btn-painel">Relatório Produto <i class="fa fa-cube" id="blue-icon-btn-painel" style="font-size:12px"></i></p>
</div>
...
<div class="container-fluid" style="width:100%;height:550px;overflow-y:auto">
    ...
    ?>
                ...
                <table class="table table-bordered" id="blue-table-cadastro-auxiliar">
                    <tr id="line-blue-table-hover">
                        ...
                        <td id="colun-blue-table">
                            <p id="blue-title-listar-exibicao">Acréscimo</p>
    ...
    <?php
            ...
            echo '<p style="color:red; text-align:center;">Nenhum produto encontrado.</p>';
        }
        $stmt->close();
    }
    ?>
